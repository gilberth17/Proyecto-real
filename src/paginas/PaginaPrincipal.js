...
export default function PaginaPrincipal() {
  return (
    ...
    <meta charset="utf-8"/>
    <meta name="keywords" content="TRAVEL IN, luxury"/>
  ...
  <section
    className="u-align-left-sm u-align-left-xs u-clearfix u-image u-section-1"
    id="carousel_ae89"
  >
    <div className="u-clearfix u-sheet u-sheet-1">
      <h1 className="u-text u-text-1">TRAVEL IN</h1>
      <h2 className="u-text u-text-palette-2-base u-text-2">luxury</h2>
      <h4 className="u-text u-text-3">AND STYLE</h4>
    </div>
  </section>
