...
export default function contact() {
  ...
  <section className="u-align-left u-clearfix u-section-1" id="carousel_08e6">
    <div
    ...
    >
      <div className="u-container-layout u-valign-middle-md u-container-layout-1">
        <h2 className="u-align-center u-custom-font u-font-merriweather u-text u-text-default u-text-1">
          {" "}
          Our Amazing Team
        </h2>
        <p className="u-align-center u-text u-text-default-lg u-text-default-md u-text-default-xl u-text-2">
      ...
      <div className="u-repeater u-repeater-1">
        <div className="u-align-center u-container-style u-custom-item u-list-item u-repeater-item u-shape-rectangle">
          <div className="u-container-layout u-similar-container u-container-layout-2">
            <h5 className="u-text u-text-default u-text-3">Gilberth Romero</h5>
            <h6 className="u-text u-text-default u-text-4">Developer</h6>
          </div>
        </div>
        <div className="u-align-center u-container-style u-custom-item u-list-item u-repeater-item">
          <div className="u-container-layout u-similar-container u-container-layout-3">
            <h5 className="u-text u-text-default u-text-5">Edna Plazas</h5>
            <h6 className="u-text u-text-default u-text-6">Developer</h6>
          </div>
        </div>
        <div className="u-align-center u-container-style u-custom-item u-list-item u-repeater-item">
          <div className="u-container-layout u-similar-container u-container-layout-4">
            <h5 className="u-text u-text-default u-text-7">Rafael Rodriguez</h5>
            <h6 className="u-text u-text-default u-text-8">Developer</h6>
          </div>
        </div>
        <div className="u-align-center u-container-style u-custom-item u-list-item u-repeater-item">
          <div className="u-container-layout u-similar-container u-container-layout-5">
            <h5 className="u-text u-text-default u-text-9">Yuri Ruiz</h5>
            <h6 className="u-text u-text-default u-text-10">Developer</h6>
          </div>
        </div>
        <div className="u-align-center u-container-style u-custom-item u-list-item u-repeater-item">
          <div className="u-container-layout u-similar-container u-container-layout-6">
            <h5 className="u-text u-text-default u-text-11">David Romero</h5>
            <h6 className="u-text u-text-default u-text-12">Developer</h6>
          </div>
        </div>
      </div>
    </div>
